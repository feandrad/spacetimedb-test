...
namespace GuildmasterMVP.Network.Generated
{
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "check_player_transition" => BSATNHelpers.Decode<Reducer.CheckPlayerTransition>(encodedArgs),
                ...
                "get_players_in_map" => BSATNHelpers.Decode<Reducer.GetPlayersInMap>(encodedArgs),
                "get_transition_zones" => BSATNHelpers.Decode<Reducer.GetTransitionZones>(encodedArgs),
                ...
                "transition_to_map" => BSATNHelpers.Decode<Reducer.TransitionToMap>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.CheckPlayerTransition args => Reducers.InvokeCheckPlayerTransition(eventContext, args),
                ...
                Reducer.GetPlayersInMap args => Reducers.InvokeGetPlayersInMap(eventContext, args),
                Reducer.GetTransitionZones args => Reducers.InvokeGetTransitionZones(eventContext, args),
                ...
                Reducer.TransitionToMap args => Reducers.InvokeTransitionToMap(eventContext, args),
