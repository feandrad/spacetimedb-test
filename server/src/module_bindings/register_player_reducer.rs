...
impl From<RegisterPlayerArgs> for super::Reducer {
    fn from(args: RegisterPlayerArgs) -> Self {
        Self::RegisterPlayer {
            username_display: args.username_display,
        }
    }
}
...
pub trait register_player {
    ...
    fn register_player(&self, username_display: String) -> __sdk::Result<()> {
        self.register_player_then(username_display, |_, _| {})
    }
...
impl register_player for super::RemoteReducers {
    fn register_player_then(
        ...
        self.imp
            .invoke_reducer_with_callback(RegisterPlayerArgs { username_display }, callback)
    }
}
